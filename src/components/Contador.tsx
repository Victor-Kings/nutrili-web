...
export function Contador (props: IContadorProps){
    return(
        <Box display="flex" flex="1" width="100%" height="98px" borderRadius={8} boxShadow="md" flexDirection="row" backgroundColor="white">
            <Flex minWidth="98px" bg="blue.200" justifyContent="center" borderRadius={8}>
            ...
            <Flex display="flex" flexDirection="column" justifyContent="center" justifySelf="center" alignItems="center" margin="auto">
                <Text fontSize="1.6rem" color="gray.200" fontWeight="medium" fontFamily="heading">{props.valueData}</Text>
                <Text fontSize="14px" color="gray.100" fontWeight="semibold" textAlign="center" fontFamily="heading">{props.contentText}</Text>
            </Flex>
        </Box>
    )
}
